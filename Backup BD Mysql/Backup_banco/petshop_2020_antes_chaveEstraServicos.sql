...
--
-- Host: 127.0.0.1
-- Generation Time: 27-Jan-2021 às 02:12
...
(4, 14, 2, 'RAGDOLL', 1, ' BANHO E TOSA ESPECIAL	-R$ 45,00.\n', 'R$ 45', '2021-01-22', '09:00:00'),
(7, 14, 2, 'RAGDOLL', 1, ' BANHO E TOSA ESPECIAL	-R$ 45,00.\n', 'R$ 45', '2021-01-22', '09:00:00'),
(8, 14, 2, 'RAGDOLL', 1, ' BANHO E TOSA ESPECIAL	-R$ 45,00.\n', 'R$ 45', '2021-01-22', '08:00:00'),
(9, 14, 2, 'RAGDOLL', 2, ' BANHO E TOSA PET GRANDE	-R$ 36,00.\n TOSA GRANDE	-R$ 24,00.\n', 'R$ 60', '2021-01-26', '15:00:00');
...
ALTER TABLE `tb_produtos`
  ...
  ADD KEY `fk_cliente_produtoCliente` (`cod_cliente`);
...
--
ALTER TABLE `tb_consulta`
  MODIFY `codConsulta` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tb_raca`
  MODIFY `cod_raca` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `tb_racatipo`
--
ALTER TABLE `tb_racatipo`
  MODIFY `cod_RacaTipo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tb_raca_novo`
--
ALTER TABLE `tb_raca_novo`
  MODIFY `cod_raca_animal` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tb_produtos`
  ADD CONSTRAINT `fk_cliente_produtoCliente` FOREIGN KEY (`cod_cliente`) REFERENCES `tb_cliente` (`CodCliente`);
