...
--
-- Host: 127.0.0.1
-- Generation Time: 29-Mar-2021 às 23:13
...
(33, 16, 3, 9, 'THANOS', '1,58 g', '4 cm', 'AZUL VERDE', '3 anos', 'MACHO', '\nVACINA CONTRA GIARDIASE\nVACINA CONTRA A LEISHMANIOSE\n', ''),
(34, 14, 2, 7, 'GARFIELD', '3,55', '12 ', 'PRETO', '1 ano', 'MACHO', 'VACINA ANTIRRABICA\n', 'nenhum'),
...
(10, 24, 34, '-PATA ESQUERDA DOENDO APÓS A QUEDA\n-POSSÍVEL FRATURA', '-DIPIRONA GOTAS 500mg 6/6H 3 dias\n-NIMESULIDA COMPRIMIDO 1G / 1Xdia /3 dias', '-RAIO X\n-TOMOGRAFIA COM CONTRASTE', '2021-03-24', '15:41:00');
...
(44, 14, 4, '35,3', '2021-03-24', '15:31:55'),
(44, 14, 9, '35,3', '2021-03-24', '15:31:55');
...
(24, 14, 2, 7, 6, 27, 'R$ 95', '2021-03-24', '16:00:00'),
(24, 14, 2, 7, 6, 28, 'R$ 95', '2021-03-24', '16:00:00'),
(25, 14, 2, 7, 6, 27, 'R$ 95', '2021-03-24', '16:20:00'),
(25, 14, 2, 7, 6, 28, 'R$ 95', '2021-03-24', '16:20:00');
...
--
ALTER TABLE `tb_compra`
  MODIFY `cod_compra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `tb_consulta_cliente`
--
ALTER TABLE `tb_consulta_cliente`
  MODIFY `cod_consulta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `tb_diagnostico`
--
ALTER TABLE `tb_diagnostico`
  MODIFY `cod_diagnostico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
