...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Dez-2020 às 22:20
...
CREATE TABLE `tb_consulta` (
  ...
  `cod_raca_animal_consulta` int(11) NOT NULL,
  `cod_veterinario` int(10) DEFAULT '0',
  `desc_servicos` varchar(200) NOT NULL,
...
(2, 9, 1, 15, 2, 'consulta', '30', '2020-12-03', '13:00:00');
...
--
ALTER TABLE `tb_cliente`
  MODIFY `CodCliente` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tb_clienteanimais`
--
ALTER TABLE `tb_clienteanimais`
  MODIFY `cod_cadastro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tb_consulta`
  MODIFY `codConsulta` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `tb_consulta`
  ...
  ADD CONSTRAINT `fk_RacaAnimaltbanimalCliente_consulta` FOREIGN KEY (`cod_raca_animal_consulta`) REFERENCES `tb_raca` (`codigo_index_raca`),
