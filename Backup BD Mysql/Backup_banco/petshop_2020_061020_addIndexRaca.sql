...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Nov-2020 às 23:29
...
--
ALTER TABLE `tb_clienteanimal`
  MODIFY `cod_cadastro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `tb_raca`
  MODIFY `codigo_index_raca` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `tb_tipo_animal`
  MODIFY `cod_tipo_animal` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
