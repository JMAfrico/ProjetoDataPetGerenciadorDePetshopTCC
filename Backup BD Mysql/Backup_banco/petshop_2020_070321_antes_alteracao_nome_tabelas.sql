...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Mar-2021 às 17:31
...
(33, 16, 2, 8, 'FDF', '4 kg', '4 cm', 'SD', '3 anos', 'FEMININO', 'VACINA ANTIRRABICA\n', ''),
(34, 14, 2, 7, 'GARFIELD', '1 g', '12 cm', 'PRETO', '1 ano', 'Escolha o sexo', 'VACINA ANTIRRABICA\n', 'nenhum');
...
(16, 14, 2, 7, 5, 28, 'R$ 75', '2021-03-08', '16:00:00'),
(16, 14, 2, 7, 5, 38, 'R$ 75', '2021-03-08', '16:00:00');
...
--
ALTER TABLE `tb_clienteanimais`
  MODIFY `cod_cadastro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `tb_consulta_cliente`
  MODIFY `cod_consulta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tb_diagnostico`
--
ALTER TABLE `tb_diagnostico`
  MODIFY `cod_diagnostico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
ALTER TABLE `tb_diagnostico`
  ...
  ADD CONSTRAINT `fk_consulta_diagnostico` FOREIGN KEY (`cod_consulta`) REFERENCES `tb_consulta` (`codConsulta`);
