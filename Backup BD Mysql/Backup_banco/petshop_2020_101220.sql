...
--
-- Host: 127.0.0.1
-- Generation Time: 10-Dez-2020 às 23:33
...
(10, 'LINDINALVA ELIZA', 'LINDINALVAELIZA@HOTMAIL.COM', 11944515151, 1199987754, 'RUA JOSÉ BORGES DO CANTO', 'SÃO PAULO', 'SP', 16, 'JARDIM CAMARGO NOVO', '08142010', 'CASA C', 'PAREDE BRANCA', '08950320827'),
(12, 'MARCOS', 'MARCOS@HOTMAIL', 11967758888, 1515156161, 'RUA JOSÉ DE ANDRADE SANDIM', 'MOGI DAS CRUZES', 'MOGI DAS CRUZES', 56, 'VILA RICA', '08810010', 'CASA', 'RUA SEM SAÍDA', '48636095824'),
(13, 'JOAO MARCOS AFRICO DA SILVA', 'JOAO_MARCOSSILVA@HOTMAIL.COM', 11962850333, 1125612203, 'RUA JOSÉ BORGES DO CANTO', 'SÃO PAULO', 'SÃO PAULO', 25, 'JARDIM CAMARGO NOVO', '08142010', 'APTO', '.', '39211358850');
...
(9, 9, 2, 'BURMESE', 'THOR', '', '', ''),
(11, 12, 2, 'PERSA', 'THOR', '2KG', '55CM', 'PRETO'),
(12, 13, 3, 'PAPAGAIO', 'LORO', '3KG', '50CM', 'AZUL E AMARELO');
...
(53, 13, 3, 'PAPAGAIO', 1, 'Serviço {BANHO E TOSA ESPECIAL}PreçoListViewSubItem: {45,00}\nServiço {DOAÇÃO DE PET}PreçoListViewSubItem: {0,00}\n', 'R$ 45', '2020-12-10', '11:11:00'),
(54, 13, 3, 'PAPAGAIO', 1, 'SERVIÇO: BANHO E TOSA ESPECIALPreço 45,00\nSERVIÇO: HIDRATAÇÃOPreço 30,00\n', 'R$ 75', '2020-12-10', '11:11:00'),
(55, 10, 2, 'SPHYNX', 1, ' BANHO E TOSA ESPECIAL	 45,00\n TAXI DOG	 10,00\n', 'R$ 55', '2020-12-10', '11:11:00'),
(56, 12, 2, 'PERSA', 1, ' BANHO E TOSA ESPECIAL	-R$ 45,00\n HOSPEDAGEM	-R$ 25,00\n', 'R$ 70', '2020-12-10', '12:00:00');
...
(1, 'THIAGO', 'AZEVEDO SILVA', 'THIAGO.SILVA@GMAIL.COM', 1154463980, 11974041224, 'RUA JOSÉ DE ANDRADE SANDIM', 'MOGI DAS CRUZES', 'SP', 'VILA RICA', '08810010', 22, 'CONJUNTO 3 - 5ºANDAR');
...
--
ALTER TABLE `tb_cliente`
  MODIFY `CodCliente` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tb_clienteanimais`
--
ALTER TABLE `tb_clienteanimais`
  MODIFY `cod_cadastro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tb_clienteanimal`
--
ALTER TABLE `tb_clienteanimal`
  MODIFY `cod_cadastro` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_consulta`
--
ALTER TABLE `tb_consulta`
  MODIFY `codConsulta` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
