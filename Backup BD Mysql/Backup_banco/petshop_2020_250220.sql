...
--
-- Host: 127.0.0.1
-- Generation Time: 25-Fev-2021 às 18:31
...
(16, 20, 3, 2, 'CORINTIANO', '2KG', '20CM', 'BRANCO/PRETO');
...
(12, 20, 3, 2, 5, 34, 'R$ 28', '2021-02-25', '16:00:00'),
(13, 14, 1, 27, 4, 27, 'R$ 50', '2021-02-26', '12:00:00');
...
--
ALTER TABLE `tb_clienteanimais`
  MODIFY `cod_cadastro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tb_compra`
--
ALTER TABLE `tb_compra`
  MODIFY `cod_compra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `tb_consulta`
--
ALTER TABLE `tb_consulta`
  MODIFY `codConsulta` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
