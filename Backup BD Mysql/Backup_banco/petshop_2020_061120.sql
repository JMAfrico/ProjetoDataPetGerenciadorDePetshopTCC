...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Nov-2020 às 21:55
...
(7, 9, 2, 2, 'MARIA', '3KG', '30CM', 'PRETO/BRAN'),
(8, 9, 1, 1, 'THOR', '10KG', '80CM', 'MARRON/BRA'),
(9, 6, 3, 3, 'LORO', '5KG', '20CM', 'AMARELO/AZ'),
(10, 6, 1, 1, 'CACHORRO', '12KG', '18CM', 'BRANCO'),
(11, 6, 1, 1, 'CACHORRO', '12K', '30CM', 'BRANCO'),
(12, 7, 3, 3, 'BLU', '3', '3', 'AZUL'),
(13, 7, 1, 1, 'CARRERINHA', '33', '32', 'PRETO'),
(14, 7, 1, 1, 'LEVADO', '16KG', '26CM', 'BRANCO NEV'),
(15, 7, 2, 2, 'LEVADO', '16KG', '26CM', 'BRANCO NEV'),
(16, 6, 2, 2, 'DSDS', 'DSDS', 'DSDS', 'DSDS'),
(17, 7, 2, 2, 'TESTE', '23', '3', 'FDFDFDFD'),
(18, 9, 2, 2, 'RE', '5', '2', '5'),
(19, 6, 2, 2, 'FDF', 'J', 'H', 'F'),
(20, 6, 3, 3, 'FRADFA', 'SDE', 'DDAS', 'SDA'),
(21, 10, 2, 2, 'MAGRELO', '35G', '26KG', 'PRETO'),
(22, 6, 2, 2, 'TOM', '23', '032', 'LILAS'),
(23, 6, 2, 2, 'TOTO', '20', '1,00', 'PRETO'),
(24, 6, 1, 1, 'DSDS', 'D', 'DS', 'D'),
(25, 6, 2, 2, 'J', 'JJ', 'JJ', 'J'),
(26, 6, 2, 2, 'DSDADADADAA', 'SD', 'DSDS', 'DD'),
(27, 6, 1, 1, 'SSA', 'SS', 'SS', 'SSS'),
(28, 6, 2, 2, 'GGGG', 'GG', 'GG', 'GGG'),
(30, 6, 1, 1, 'WWW', 'WW', 'WW', 'W'),
(32, 7, 3, 3, 'VAA', 'A', 'VAVA', 'VAVA'),
(35, 6, 1, 1, 'WEWEQ', 'S', 'SD', '3'),
(36, 6, 2, 2, 'AAAGGG', 'GAGA', 'G', 'GAGA'),
(37, 6, 1, 1, 'SKLLK', 'LL', 'LL', 'LL'),
(38, 7, 3, 3, 'BBB', 'BB', 'BB', 'BB'),
(39, 6, 3, 3, 'DDDDDDDDDDDDDDDDDDDDDD', 'DD', 'DD', 'DDD'),
(40, 6, 2, 2, 'SDSDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDSSS', 'SS', 'S', 'S');
...
ALTER TABLE `tb_raca`
  ...
  ADD KEY `tb_raca_ibfk_1` (`cod_raca_animal`);
...
--
ALTER TABLE `tb_clienteanimal`
  MODIFY `cod_cadastro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
