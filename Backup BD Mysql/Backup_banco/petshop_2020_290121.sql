...
--
-- Host: 127.0.0.1
-- Generation Time: 29-Jan-2021 às 15:02
...
INSERT INTO `tb_consulta` (`codConsulta`, `CodCliente`, `cod_tipo_animal_consulta`, `cod_raca_animal_consulta`, `cod_veterinario`, `valortotal_consulta`, `dataConsulta`, `horaConsulta`) VALUES
(13, 15, 1, 15, 2, '0', '2021-01-28', '15:00:00'),
(14, 14, 3, 13, 1, '-', '2021-01-28', '16:00:00');
...
ALTER TABLE `tb_itens_cliente`
  ...
  ADD KEY `fk_codConsultaTbConsulta` (`cod_consulta`);
...
--
ALTER TABLE `tb_consulta`
  MODIFY `codConsulta` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tb_servicos`
  MODIFY `cod_servico` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `tb_itens_cliente`
  ADD CONSTRAINT `fk_codConsultaTbConsulta` FOREIGN KEY (`cod_consulta`) REFERENCES `tb_consulta` (`codConsulta`),
