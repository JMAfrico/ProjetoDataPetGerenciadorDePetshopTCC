...
--
-- Host: 127.0.0.1
-- Generation Time: 26-Fev-2021 às 20:53
...
--
ALTER TABLE `tb_compra`
  MODIFY `cod_compra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `tb_consulta_cliente`
--
ALTER TABLE `tb_consulta_cliente`
  MODIFY `cod_consulta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
